...
if (use_cached_net==false)
    ...
    save('cache/NN_model',...
        'trained_status','net','hidden_layers');
...
if do_train
    ...
    save('cache/NN_model','inputs','feedbackDelays','layerStates','targets',...
        ...
        'trained_status','training_complete','net','hidden_layers');
...
if (archive_net) && (trained_status)
   ...
   if (exist(currentFileName)==2)
       ...
       foldername = strcat("cache/", string(y), '_', string(m),...
           ...
           num2str(net_closed.numInputDelays), '_', ...
           num2str(net_closed.numFeedbackDelays), '_',...
