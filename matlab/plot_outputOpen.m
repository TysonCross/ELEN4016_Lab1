...
figOutputOpen =  figure('Position',fig_pos);
set(figOutputOpen,'numbertitle','off',...                            % Give figure useful title
        'name','Test output from NN and BlackBox (open net)',...
        'Color','white');
fontName='CMU Serif';
fontSize = 28;
...
y = [cell2mat(outputs(TR.testInd));...
    cell2mat(targets(TR.testInd))];
...
% Axes and labels
set(axOutputOpen,'FontSize',fontSize,...
    'Color','none',...
    'Box','off',...
...
% t1 = title(figOutputOpen.Name);

% Legend
legend1 = legend;
set(legend1,...
     'Position',[0.376701213855322 0.850016069886174 0.28523166023166 0.132394109235202],...
     'Box','on');
hold on
